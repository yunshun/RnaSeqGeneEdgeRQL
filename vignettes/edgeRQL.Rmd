...
FileURL <- paste(
  ...
  sep="&")
download.file(FileURL, method="internal", "GSE60450_Lactation-GenewiseCounts.txt.gz")
}
```
...
![Boxplots of quality scores by base position for the first FASTQ file.](../inst/extdata/QualityScores.png)
